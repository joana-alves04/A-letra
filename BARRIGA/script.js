...
// ✅ CORREÇÃO: usa sempre DOMContentLoaded para garantir que o DOM
// está completamente pronto, mesmo ao navegar de outra página
document.addEventListener("DOMContentLoaded", arrancarTudo);

// Segurança para o caso de já ter passado o DOMContentLoaded
// (ex: página em cache ou navegação via bfcache)
